...
def osx_build():
    ...
    os.system("cd dependencies && sudo tar -xvf geckodriver-v0.14.0-linux32.tar.gz && sudo mv -R geckodriver $HOME")
    print G + "[!] Done installing dependences! [!]" + W
    sys.exit(0)
...
while True:
    ...
    if getos == "1":
        ...
        print O + "Getting GeckoDriver" + W
        sleep(1.5)
        os.system("cd dependences && sudo tar -xvf geckodriver-v0.13.0-linux32.tar.gz && sudo mv geckodriver /usr/bin ")
        print G + "Done installing dependences!" + W
        break
    elif getos == "3":
        osx_build()
